...
If you are unsure what your input data should look like, have a look at the `example_quantile`, `example_integer`, `example_sample_continuous` and `example_binary` data sets provided in the package. 
