...
\frac{2}{\alpha} \cdot (\text{lower} - \text{true_value}) \cdot \mathbb{1}(\text{true_values} < \text{lower}) + \\
\frac{2}{\alpha} \cdot (\text{true_value} - \text{upper}) \cdot
\mathbb{1}(\text{true_value} > \text{upper})$$


where $\mathbb{1}()$ is the indicator function and $\alpha$ is the decimal value that
