...
This Vignette provides the code for visualisations that were previously part of `scoringutils` but have been removed with `scoringutils` version `2.0`. For alternative ways to implemenent data visualisations, we refer to the `hubVis` [package](https://github.com/Infectious-Disease-Modeling-Hubs/hubVis).
...
# Code is commented out because `ggdist` requires R version 4.1.0, while
# scoringutils does not. 
# library(ggdist)
