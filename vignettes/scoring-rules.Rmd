...
knitr::include_graphics("scoring-rules/input-point.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="A nice image."}
knitr::include_graphics("scoring-rules/input-binary.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="A nice image."}
knitr::include_graphics("scoring-rules/input-sample.png")
```
...
```{r, echo=FALSE, out.width="100%", fig.cap="A nice image."}
knitr::include_graphics("scoring-rules/input-quantile.png")
```
...
The quantile score is also called pinball loss. See [here](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1008618) for more details. 
