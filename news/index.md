...
[`score()`](https://epiforecasts.io/scoringutils/reference/score.md). We
updated and improved all function documentation and added new vignettes
to guide users through the package. Internally, we refactored the code,
improved input checks, updated notifications (which now use the `cli`
...
- Some `as_forecast_<type>()` functions like
  e.g. [`as_forecast_point()`](https://epiforecasts.io/scoringutils/reference/as_forecast_point.md)
  and
  [`as_forecast_quantile()`](https://epiforecasts.io/scoringutils/reference/as_forecast_quantile.md)
...
- Removed abs_error and squared_error from the package in favour of
  ...
  [`Metrics::se`](https://rdrr.io/pkg/Metrics/man/se.html).[`get_duplicate_forecasts()`](https://epiforecasts.io/scoringutils/reference/get_duplicate_forecasts.md)
...
- [`wis()`](https://epiforecasts.io/scoringutils/reference/wis.md) now
  errors by default if not all quantile levels form valid prediction
