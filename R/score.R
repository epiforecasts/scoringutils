...
#'   \item `predicted` - predictions or predictive samples for one
#'   observed value. (You only don't need to provide a prediction column if
#'   you want to score quantile forecasts in a wide range format.)}
#' For scoring integer and continuous forecasts a `sample_id` column is needed:
#' \itemize{
#'   \item `sample_id` - an index to identify the predictive samples in the
#'   'predicted' column generated by one model for one observed value. Only
