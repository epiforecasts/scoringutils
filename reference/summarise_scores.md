# Summarise scores as produced by [`score()`](https://epiforecasts.io/scoringutils/reference/score.md)
...
[`score()`](https://epiforecasts.io/scoringutils/reference/score.md). If
you do, you also have to manually update the attribute by calling
