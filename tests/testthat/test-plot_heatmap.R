...
test_that("plot_heatmap() works as expected with interval score", {
  p <- plot_ranges(scores, x = "model") +
...
test_that("plot_heatmap() works as expected with dispersion", {
  p <- plot_ranges(scores, y = "dispersion", x = "model") +
