...
scoringutils::plot_interval_coverage(scores) + 
  ggplot2::ggtitle("Interval Coverage")

scoringutils::plot_quantile_coverage(scores) + 
...
scoringutils::plot_wis_components(scores, facet_formula = ~ value_desc)
```
