...
Every forecast type has a corresponding \texttt{as\_forecast\_...()}
function that transforms the input into a \texttt{forecast} object and
validates it (see Figure \ref{fig:flowchart-validation} for details). A
...
\texttt{forecast\_quantile} or \texttt{forecast\_sample}).

All \texttt{as\_forecast\_...()} functions can take additional arguments
that help facilitate the process of creating a forecast object:
