...
```{r score-table, fig.width = 11, fig.cap="Coloured table to visualise the computed scores. Red colours indicate that a value is higher than ideal, blue indicicates it is lower than ideal and the opacity indicates the strength of the deviation from the ideal."}
score(example_quantile) |>
  summarise_scores(by = c("model", "target_type")) |>
...
<!-- Some additional analyses and visualisations can be found in section \ref{additional} in the SI.  -->
...
<!-- and Figure \ref{fig:wis-components-relative} in the SI.  -->
...
<!-- (see a quantile-based example in Figure \ref{fig:pit-plots-quantile} in the SI):  -->
