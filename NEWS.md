...
- The functions `as_point` and `as_quantile` have been added to allow conversion of various forecast types to point and quantile forecasts respectively. The function `sample_to_quantile` is no longer exported.
